 ...
 * Copyright 2017 NXP
 *
 * Configuration settings for the Alientek i.MX6U-MINI.
 */
#ifndef __IMX6U_MINI_CONFIG_H
#define __IMX6U_MINI_CONFIG_H
	...
	"ip=dhcp nfsroot=${serverip}:${nfsroot},v3,tcp\0" \
		...
		"findfdt="\
			"if test $fdt_file = undefined; then " \
				...
				"if test $board_name = i.MX6U && test $board_rev = MINI; then " \
